        ...
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 animate__animated animate__fadeIn banner flex flex-col items-center self-center lg:w-full lg:text-center">
              <h1 className="text-6xl inline-block w-full text-dark dark:text-light font-bold capitalize dark:text-ligh xl:text-5xl lg:text-center lg:text-6xl md:text-5xl sm:text-3xl">
                {`Hi! I'm Ashley,`} <br />
